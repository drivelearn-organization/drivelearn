...
public class CarSteer : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        if (rT.rotation.z > 0)
        {
            carControll.StreewheelFormMoblie = rT.rotation.z * -1;

        }
        else if (rT.rotation.z < 0)
        {
            carControll.StreewheelFormMoblie = rT.rotation.z * -1;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        carControll.StreewheelFormMoblie = 0f;
    }
